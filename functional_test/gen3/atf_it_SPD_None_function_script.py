...
test_defined_table = [
    ["TC1", "SPD_None_function", "8", "1", "11111110"],
]
...
if __name__ == "__main__":
    ...
    shutil.copy2(
        PROJECT_SOURCE_DIR + "/gen4/scripts/target_scripts/atf_it_SPD_None_function_cmd.sh", ROOTFS
    )

    os.environ["COMMAND"] = f"./atf_it_SPD_None_function_cmd.sh {TEST_ID}"
    os.environ["TEST_COMMAND"] = f"./atf_it_SPD_None_function_cmd.sh {TEST_ID}"
